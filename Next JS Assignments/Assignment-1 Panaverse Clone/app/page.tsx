...
import PavaverseLogo from "@/public/panaverseLogo.png";
  ...
  return (
    <div>
      ...
      <div className="my-0 mx-auto py-[2rem]  md:px-[6rem] max-w-fit md:max-w-[64rem]">
        ...
        <Image src={PavaverseLogo} alt="PanaverseLogo" className="" />
        <h2 className="text-[#159957] text-[1.5em] mb-[1rem]">
        ...
        <a
          ...
          className="text-[1.7em] text-[#1E6BB8] hover:underline "
        >
        ...
        <a
          ...
          className="text-[1.2em] text-[#1E6BB8] hover:underline my-4"
        >
          This document on Google Docs
        </a>
        <p className="py-4 text-[#606C71] text-[1.1rem]">
          ...
          voice computing, ambient computing, and more. <br /> <br />
        ...
        <a
          ...
          className="text-[1.2em] text-[#1E6BB8] hover:underline my-6"
        >
        ...
        <h2 className="text-[#159957] text-3xl pb-4 pt-4">
          Detailed Course Syllabus
        </h2>{" "}
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">Quarter I (Core)</h2>{" "}
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">
          CS-101: Object-Oriented Programming using TypeScript
        </h2>{" "}
        <p className="text-[#606C71] mb-[1em] text-[1.1rem]">
          Duration: 13 Weeks <br /> <br /> Course Description: <br /> <br /> We
          will start the program by learning the fundamentals of Object-Oriented
          programming using JavaScript and TypeScript. We will also understand
          the latest Web trends i.e. Web 3.0 and Metaverse concepts and try to
          understand their working from the perspective of the users. <br />{" "}
          <br />
          Course Outline: <br /> <br />
        </p>
        <h2 className="text-[#159957] text-2xl pb-2 pt-0">
        ...
        <a
          ...
          className="text-[1.2em] my-[10px] text-[#1E6BB8] hover:underline"
          target="_blank"
        >
        ...
        <br /> <br />
        <p className="mb-[1em]">Fundamentals of JavaScript and Node.js Quiz</p>
        <p className="mb-[1em]">Topics Covered in the Quiz:</p>
        <p className="text-[#606C71] mb-[1em] text-[1.1rem]">
        ...
        <p className="text-[#606C71] mb-[1em] text-[1.1rem]">
          TypeScript Professional Proficiency QuizFundamentals of Version
          Control with Git (Recorded Videos)
        </p>
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">
        ...
        <p className="text-[#606C71] mb-[1em] text-[1.1rem]">Homework:</p>
        <p className="text-[#606C71] mb-[1em] text-[1.1rem]">
        ...
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">Quarter II (Core)</h2>
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">
        ...
        <p className="text-[#606C71] mb-[1em] text-[1.1rem]">Course Outline:</p>
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">
        ...
        <br /> <br />
        <p className="text-[#606C71] mb-[0.5em] text-[1.1rem]">
          Stop building REST APIs for your Next.js apps, use tRPC instead
        </p>
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">SQL and Prisma</h2>
        <a
        ...
        <br /> <br />
        <h2 className="text-[#159957] text-xl pb-4 pt-4">
        ...
        <br /> <br />
        <h2 className="text-[#159957] text-2xl pb-4 pt-4">Tokennomics</h2>
        <p className="text-[#606C71] mb-[0.99em] text-[1.1rem]">
