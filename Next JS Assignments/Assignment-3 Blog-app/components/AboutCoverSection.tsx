    ...
    >
      ...
      <div className="w-full pb-10 text-left xs:p-10 lg:px-16 md:w-1/1/2">
        ...
        <p className="mt-4 text-base capitalize font-medium md:text-sm lg:text-base">
          Hey there! 👋 I&apos;m a dedicated Meta Certified Front End Developer
          with over a year of experience in web development. Currently studying
          at the University of Agriculture Faisalabad and diving into AI through
